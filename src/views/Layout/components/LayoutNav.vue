...
<template>
    <header>
        <div class="wrap">
            ...
            <div class="right-box"  v-enter="' enterNav'">
                <ul>
                    ...
                    <li id="line-icon">
                        <a href="https://line.me/ti/p/KfC6y_RhJG" target="_blank"><img src="@/assets/images/line-icon.png" alt=""></a>
                    </li>
                </ul>
            </div>
            <!-- mobile navbar -->
            <div class="mobile-nav" @click="sidebarShow" v-enter="' enterOpacity'">
                <span></span>
            </div>
        </div>
        <!-- mobile sidebar -->
        ...
        <div :class="sidebar ? 'sidebar-mask show' : 'sidebar-mask'" @click="sidebarClose"></div>
...
header {
    ...
    .wrap {
        ...
        .right-box {
            ...
            >ul {
                ...
                border-radius: 30px;
                box-shadow: 1px 1px 3px rgba(#AF7751, 0.4);
    ...
    .mobile-nav {
        ...
        width: 70px;
        height: 70px;
        background: url(@/assets/images/logo-background.png);
